...
export interface ExplorerLinkProps {
  address: string;
  type: "account" | "object" | "transaction";
  children?: React.ReactNode;
}

export function ExplorerLink({ address, type, children }: ExplorerLinkProps) {
  let explorerLink = "";
  if (type === "account") {
    explorerLink = `https://explorer.aptoslabs.com/account/${address}?network=${NETWORK}`;
  } else if (type === "object") {
    explorerLink = `https://explorer.aptoslabs.com/object/${address}?network=${NETWORK}`;
  } else if (type === "transaction") {
    explorerLink = `https://explorer.aptoslabs.com/txn/${address}?network=${NETWORK}`;
  }
